...
public class IntrFrm_InputSet extends javax.swing.JInternalFrame {

    int count=0;
    
    public IntrFrm_InputSet() {
        initComponents();  
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText(" Directions :\n  ●  Only one character between 'a' to 'z' is allowed for Set Name. \n  ●  Set Element is comma separated list of 'n' characters  (alphabets, numbers \n       or special Symbols). The form of set must be strictly as : a,b,c,d        \n  ●  z - is predined set containing all alphabets, numbers and special symbols).");
        jTextArea1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jTextArea1.setFocusable(false);

        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Input Sets", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(51, 51, 255))); // NOI18N
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Set Name (1 Character)", "Set Elements"
            }
        ) {
    ...
    {        
        count=CATModeler.data.loadInputSetFrm(table);        
        textF_cnt.setText(String.valueOf(count));        
    }
    
    private boolean chkSet(String str)
    {
        boolean flag=true;
    ...
    public boolean chkAndLoadToObject()
    {
        ...
        {   
            ...
            {   
                    ...
                    if(value.length()!=1)
                    {
                        CATModeler.setMessages("Input Sets | Row "+(r+1)+" - Invalid Set Name!", "Error!", 0);
                        flag=false;
                        break;
                    }
                    else if(value.charAt(0)<'a' || value.charAt(0)>='z')
                    {
                        CATModeler.setMessages("Input Sets | Row "+(r+1)+" - Set Name must be a lower case character and must not be 'z' !", "Error!", 0);
                        flag=false;
                        break;
                    }
                    else if(list.contains(value.charAt(0)))
                    {
                        CATModeler.setMessages("Input Sets | Row "+(r+1)+" - Set name already in use!", "Error!", 0);
                        flag=false;
                        break;
                    }  
                    else
                    ...
                    value=String.valueOf(table.getModel().getValueAt(r,1));
                    if(value.equals(""))
                    {
                        CATModeler.setMessages("Input Sets | Please fill all entries!", "", 0);
                        flag=false;
                        break;
                    }
                    else if(!chkSet(value))
                    {
                        CATModeler.setMessages("Input Sets | Row "+(r+1)+" - Invalid Set!", "Error!", 0);
                        flag=false;
                        break;
                    }
        ...
        {   
            ...
            for(r=0;r<count;r++)
            {             
                tmp=String.valueOf(table.getModel().getValueAt(r,0));                
                CATModeler.data.addInputSet(tmp.charAt(0), String.valueOf(table.getModel().getValueAt(r,1)));
                /*
                if(flag==false)
                { break ; }
                * 
